	...
	<div id="tasks" class="tasks col-md-7">
		...
		<div ng-if="task">
			...
			<div class="taskHeader">
				...
				<span class="taskSubject"><a href="javascript:void(0)" editable-text="task.title" onbeforesave="updateTaskTitle(task, $data)">{{ task.title }}</a></span>
			...
			<div class="taskDesc">
				...
				<div ng-if="task.description">
					<span editable-textarea="task.description" e-form="editTaskDescBtn" onbeforesave="updateTask(task)">{{task.description}}</span>
