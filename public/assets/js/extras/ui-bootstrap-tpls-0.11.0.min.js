...
.controller('AccordionController', ['$scope', '$attrs', 'accordionConfig', 'TaskListService', 'TaskService', function ($scope, $attrs, accordionConfig, TaskListService, TaskService) {
...
.directive('accordionGroup', function(ProjectService, TaskListService, TaskService) {
  return {
    ...
    link: function(scope, element, attrs, accordionCtrl) {
      ...
      scope.fetchTasks = function()
      {
        ...
        if (scope.isOpen)
        {
          ...
          var tasklist = TaskListService.getTaskList(scope.tasklist);

          tasklist.tasks = null;

          TaskService.fetchTasks(project, tasklist).$promise.then(function(tasks) {
...
angular.module("template/accordion/accordion-group.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("template/accordion/accordion-group.html",
    "<div class=\"panel panel-custom-color animated fadeInLeft\">\n" +
    "  <div class=\"panel-heading\" ><a class=\"accordion-toggle\" ng-click=\"toggleOpen(); fetchTasks($index)\" accordion-transclude=\"heading\"><span ng-class=\"{'text-muted': isDisabled}\">{{heading}}</span></a></div>\n" +
    "  <div class=\"panelProgress\">\n" +
    "    <div class=\"pprogress sampleprog\"></div>\n" +
    "  </div>\n" +
    "  <ul class=\"list-group panel-toggle\" collapse=\"!isOpen\" ng-transclude>\n" +
    "  </ul>\n" +
    "</div>");
}]);
...
angular.module("template/datepicker/datepicker.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("template/datepicker/datepicker.html",
    ...
    "      <th><button type=\"button\" class=\"btn btn-info pull-left\" ng-click=\"move(-1)\"><i class=\"fa fa-chevron-left\"></i></button></th>\n" +
    "      <th colspan=\"{{rows[0].length - 2 + showWeekNumbers}}\"><button type=\"button\" class=\"btn btn-primary btn-block\" ng-click=\"toggleMode()\"><strong>{{title}}</strong></button></th>\n" +
    "      <th><button type=\"button\" class=\"btn btn-info pull-right\" ng-click=\"move(1)\"><i class=\"fa fa-chevron-right\"></i></button></th>\n" +
    "    </tr>\n" +
